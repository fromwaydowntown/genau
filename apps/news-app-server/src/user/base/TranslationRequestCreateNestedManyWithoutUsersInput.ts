...
@InputType()
class TranslationRequestCreateNestedManyWithoutUsersInput {
...
export { TranslationRequestCreateNestedManyWithoutUsersInput as TranslationRequestCreateNestedManyWithoutUsersInput };
